...
/**
 * @group functional
 * @group Module_RedisExample
 */
class RedisDemoTest extends FunctionalTestCase
{
    ...
    public function testReadSingleNotFound_Json( $browserTemplate )
    {
        ...
        $request = new HTTPRequest( '/example/redis/' . $randomId );
    ...
    {
        $request = new HTTPRequest( '/example/redis', 'PUT' );
        $request->setHeaders( $browserTemplate->getHeaders() );
        $request->setHeader( 'Accept', 'application/json' );
    ...
    public function testReadSingle_Json( $browserTemplate )
    {
        ...
        $request = new HTTPRequest( '/example/redis/' . self::$testIds[ $iteration ] );
        $request->setHeaders( $browserTemplate->getHeaders() );
        $request->setHeader( 'Accept', 'application/json' );
    ...
    {
        $request = new HTTPRequest( '/example/redis' );
        $request->setHeaders( $browserTemplate->getHeaders() );
        $request->setHeader( 'Accept', 'application/json' );
    ...
    public function testUpdateSingle_Json( $browserTemplate )
    {
        ...
        $request = new HTTPRequest( '/example/redis/' . self::$testIds[ $iteration ], 'POST' );
        $request->setHeaders( $browserTemplate->getHeaders() );
        $request->setHeader( 'Accept', 'application/json' );
        $request->setParam( 'name', $newName );
    ...
    public function testDeleteSingle_Json( $browserTemplate )
    {
        ...
        $request = new HTTPRequest( '/example/redis/' . self::$testIds[ $iteration ], 'DELETE' );
        $request->setHeaders( $browserTemplate->getHeaders() );
        $request->setHeader( 'Accept', 'application/json' );
