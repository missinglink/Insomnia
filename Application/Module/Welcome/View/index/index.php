<div class="insomnia">
    <div class="insomnia-error-header">
        ...
        <div class="insomnia-title">
            <h1 class="error icon" style="background-image: url('/insomnia/icon/android/ic_menu_duration.png');">Insomnia</h1>
            <h4>Welcome to the Insomnia Framework Beta Release!</h4>
        </div>
    </div>
    ...
    <p>Insomnia Framework beta1 <span class="error">This release is still in active development.</span></p>
