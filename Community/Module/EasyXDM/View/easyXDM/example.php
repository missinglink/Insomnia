...
<div class="insomnia">
    <div class="insomnia-error-header">
        ...
        <div class="insomnia-title">
            <h1 class="error">XDM Client</h1>
            <h4>Cross-Domain messaging client</h4>
        </div>
    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var xhr = new easyXDM.Rpc({
                    remote: "http://ws.local.bnt/xdm/hash"
                }, {
                    remote: {
...
//                        getResponse( xhr );
                          $('#response').removeClass().addClass( 'prettyprint' ).addClass( 'lang-json' );
                          $('#response').text( stringify( $.parseJSON( response.data ) ) );
